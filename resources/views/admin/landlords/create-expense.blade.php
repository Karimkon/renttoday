...
@section('title', 'Add Expense for ' . $landlord->name)
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">For: {{ $landlord->name }} - {{ \Carbon\Carbon::createFromFormat('Y-m', $month)->format('F Y') }}</small>
                </div>
                <a href="{{ route('admin.landlords.monthly-report', ['landlord' => $landlord->id, 'month' => $month]) }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.landlords.expenses.store', $landlord) }}" method="POST">
                @csrf
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Note:</strong> This expense will be deducted from the amount due to the landlord for {{ \Carbon\Carbon::createFromFormat('Y-m', $month)->format('F Y') }}.
                    The commission calculation remains unchanged.
                </div>
