...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0"><i class="bi bi-cash-coin me-2"></i> Edit Expense</h3>
            ...
            <form action="{{ route('admin.expenses.update', $expense) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-select" required>
                                ...
                                @foreach($expenseTypes as $key => $label)
                                    <option value="{{ $key }}" {{ old('type', $expense->type) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="payment_method" class="form-control" 
                                   value="{{ old('payment_method', $expense->payment_method) }}" required 
                ...
                <div class="mb-3">
                    ...
                    <textarea name="notes" class="form-control" rows="3" 
                              placeholder="Any additional notes about this expense...">{{ old('notes', $expense->notes) }}</textarea>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <a href="{{ route('admin.expenses.show', $expense) }}" class="btn btn-info btn-lg">
